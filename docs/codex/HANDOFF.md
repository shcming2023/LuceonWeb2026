...
- `TASK-20260509-101245-P0-Post-Ollama-Standardization-Validation-Authorization`: assigned to Director. Director must decide whether to authorize one post-standardization production-candidate validation pass, hold validation, or request more read-only evidence. Production release readiness remains unclaimed.
