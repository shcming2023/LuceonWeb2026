...
- Director decision row `TASK-20260508-123045-P0-Production-Override-Release-Boundary-Decision` is open for the remaining release-boundary decision: accept, narrow, or remove MinIO console exposure before release-candidate naming, and decide where strict AI/model configuration should live.
