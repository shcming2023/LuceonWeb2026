...
- Director decision row `TASK-20260508-140545-P0-Release-Readiness-Runtime-Validation-Authorization` is open for the next runtime-validation wave. Production release readiness remains unclaimed.
