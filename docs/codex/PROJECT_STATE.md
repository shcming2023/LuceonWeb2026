...
| TD-018 | Open | Production Ollama `qwen3.5:9b` dependency-health chat smoke timed out before the adaptive evidence-pack controlled upload could be created. | Task 34 accepted this as blocked evidence. Task 35 is assigned for non-destructive readiness diagnosis and recovery planning; production release readiness remains unclaimed. |
