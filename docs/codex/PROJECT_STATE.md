...
- Scoped production-local override implementation is assigned to `TASK-20260508-134708-P0-MinIO-Console-Local-Only-Production-Override-Implementation`. Production release readiness remains unclaimed. DB, MinIO data, Docker volume, task, artifact, and secret mutation remain forbidden.
