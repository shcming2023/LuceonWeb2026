...
async function runTest() {
  ...
  console.assert(resData.logObservation.source === 'mineru-log', 'Expected logObservation from mineru-log');
  console.assert(Boolean(resData.logObservation.activityLevel), 'Expected logObservation activityLevel');
